...
def draw_screen_sync_setup(surf, cs):
    ...
    # Rows 4-8: per-category TX/RX toggles.  Dimmed when master sync is
    # off, but still tappable (so the user can pre-configure their
    # categories without turning on the broadcaster).
